...
tf.compat.v1.flags.DEFINE_string('advtrain_attack_method', 'MadryEtAl', "FastGradientMethod, MadryEtAl")
tf.compat.v1.flags.DEFINE_string('attack_method', 'MadryEtAl', "FastGradientMethod, MadryEtAl")
tf.compat.v1.flags.DEFINE_float('eps', 0.05, "maximal eps for attacks")
tf.compat.v1.flags.DEFINE_integer('baseline_epoch', 1, "epoch of the checkpoint to load")
